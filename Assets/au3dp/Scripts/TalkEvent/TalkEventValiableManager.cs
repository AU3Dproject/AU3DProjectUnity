...
[SerializeField]
public class TalkEventValiableManager : ManagerMonoBehaviour<TalkEventValiableManager>,ISerializationCallbackReceiver{
	...
	public class Variable {
		...
		public int getInt() {
			...
			if (int.TryParse(value, out o)) {
				...
				throw new ArgumentException("変数:[" + value + "]はInt型じゃ（ないです）");
			}
		}
		public float getFloat() {
			...
			if (float.TryParse(value, out o)) {
				...
				throw new ArgumentException("変数:[" + value + "]はFloat型じゃ（ないです）");
			}
		}
		public bool getBool() {
			bool o;
			if (bool.TryParse(value, out o)) {
				...
				throw new ArgumentException("変数:[" + value + "]はBool型じゃ（ないです）");
			}
		}
